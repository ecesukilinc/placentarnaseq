...
dir.create('/rsrch5/home/epi/bhattacharya_lab/download/01-aws-download/pass')
setwd('/rsrch5/home/epi/bhattacharya_lab/download/01-aws-download/pass')
...
#              NanoFilt,'-l 200  -q 7 >> ',
#              paste0('/rsrch5/home/epi/bhattacharya_lab/download/01-aws-download/trim/',
#                     out)))
# system(paste('gzip',
#              paste0('/rsrch5/home/epi/bhattacharya_lab/download/01-aws-download/trim/',
#                     out)))
# 
# 
# out_trim = paste0('/rsrch5/home/epi/bhattacharya_lab/download/01-aws-download/trim/',
#                   out,'.gz')
# 
# dir.create('/rsrch5/home/epi/bhattacharya_lab/download/01-aws-download/bam/')
# bam_folder='/rsrch5/home/epi/bhattacharya_lab/download/01-aws-download/bam/'
# 
# 
# ### ALIGN TO ENSEMBL REFERENCE GENOME v110
